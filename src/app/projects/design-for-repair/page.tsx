...
<p>for future product development which is useful to know for designers and environmental advocates who rely on these techniques to make their products easier to maintain.</p>
        </div>
      </motion.div>
    </div>
  );
