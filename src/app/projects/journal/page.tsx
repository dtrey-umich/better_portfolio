    ...
    <div className="pt-32 pb-16 min-h-screen">
      ...
      >
        ...
        <div className="prose prose-lg max-w-none">
          <p className="mb-6">A lot of my making comes from things I need since I would rather learn how something is made, make it myself, and give it handmade sentimental value than buy it. In this case, I needed a journal to keep track of assignments in my Junior year of high school. I could have used the mass-produced one that I found in my closet but I figured that was too poorly constructed for daily use. Instead, I deconstructed that notebook and rebound it with a new, stronger, and better-looking cover made of leather.
