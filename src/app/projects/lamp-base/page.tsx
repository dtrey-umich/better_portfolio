    ...
    <div className="pt-32 pb-16 min-h-screen">
      ...
      >
        ...
        <div className="prose prose-lg max-w-none">
          <p>I always need an atrocious amount of light for my desk. For a while, that light was provided by a single multi-jointed desk lamp from Ikea which was fine until I started to do a lot more building and found a need for more light. In June of 2021, I bought a second lamp. The issue was that Ikea designed these lamps with tiny bases that provided little support for the high use I was putting them through, causing my lamps to be unstable. Eager to fix the problem, I designed my own base.
