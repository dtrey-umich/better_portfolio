...
<p className="mb-6">computer because I was so proud of how they turned out. That sticker is still on the back of that computer to this day.</p>
        </div>
      </motion.div>
    </div>
  );
