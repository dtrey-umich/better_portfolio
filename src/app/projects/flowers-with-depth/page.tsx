    ...
    <div className="pt-20 pb-16 min-h-screen">
      ...
      >
        ...
        <div className="flex justify-between items-center mb-8">
          <p className="text-xl" style={{ fontFamily: 'Trey Handwrite, cursive', color: '#EC6F6B' }}>Using robotics to take dynamic pictures of flowers</p>
...
<div className="flex flex-col md:flex-row gap-4 my-8">
              <div className="flex-1 w-full"><p className="mb-6">I love how in some of these photos the flowers bring an element of movement to the composition. For example, in the photo on the right, the grain of the flowers guides the viewer’s eyes from the center of the image outward which is very appealing. You can see the same effect in the image of a smaller flower below. In that photo, I especially like how the movement and symmetry of the subject are contrasted with the dark space.</p>
<p className="mb-6">I have shot many subjects with a macro lens against a solid background before. What makes this project special is the video I made to go with the photos. This video, seen to the left, not only details how I shot each flower but also features a series of robotics-enabled clips. In these clips, the flowers rotate back and forth on the screen to show off their colors, textures, and depth. To make these, I mounted each subject on a metal clip attached to a programmable servo motor. Then, using an Arduino and my laptop, I programmed and filmed the motion of each flower. Finally, using the best clips and video editing software, I created longer repetitive sequences. I suppose that I could have done all of this manually, rotating the flowers back and forth by hand. However, this simple setup allowed me to capture the motion of my subjects more precisely. I see this project as a precursor to my Robot Arm project in which I seek to use robotics to film clips like these but at a much larger scale.</p></div>
<div className="flex-1 w-full"><div className="my-8"><blockquote className="tiktok-embed" cite="https://www.tiktok.com/@yellowbolt__/video/7097562787790179630" data-video-id="7097562787790179630" style={{maxWidth:'605px',minWidth:'325px'}} > <section> <a target="_blank" title="@yellowbolt__" href="https://www.tiktok.com/@yellowbolt__?refer=embed">@yellowbolt__</a> <p>Flowers are my favorite part of spring time :)</p> <a target="_blank" title="♬ original sound - Trey Davis" href="https://www.tiktok.com/music/original-sound-7097562688997477166?refer=embed">♬ original sound - Trey Davis</a> </section> </blockquote> <Script src="https://www.tiktok.com/embed.js" /></div></div>
            </div>
