...
<p className="mb-6">at that job, I discovered that a lot of background work takes place to create simple products. I knew that manufacturing systems were complex but I began to understand the depth of that complexity in a way only experiencing it could deliver. In this work, I wanted to show some of that complexity as I did in the lighter drawing. I tried to break down the process and display some of the machines used to make paper labels, ultimately discovering that attempting to represent the manufacturing process of even a simple product in all its complexity was impossible in these highly literal drawings. This pushed me to create the first abstract sculptural work for this set of art pieces.</p>
        </div>
      </motion.div>
    </div>
  );
