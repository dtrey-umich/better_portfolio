...
<div className="flex flex-col md:flex-row gap-4 my-8">
              <div className="flex-1 w-full"><p className="mb-6">I used TouchDesigner as the OSC controller, binding release commands for all eight motors to keyboard keys. To speed up sonic experimentation, the project can record eight tracks of timed triggers from a simple interface, so I can layer triggers and loop them during the installation. To further connect viewers to the piece, I wanted it to react when someone looked directly at it by turning off. I chose to manually trigger this function using Touchdesigner image processing nodes that detect when my finger is on my phone camera, wirelessly streaming video to my laptop. While in the installation, I held my finger on the camera to run the system; if I saw someone lingering on the piece, I could lift my finger to pause it, often to surprised reactions.</p></div>
