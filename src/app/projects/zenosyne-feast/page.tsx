...
<p className="mb-6">also bear some resemblance to human remains and blood, and that’s completely intentional. In addition to the composition looking disgusting, I wanted to convey that feasting on earth hurts other humans, and the red yarn and blood-like liquid establish that connection well.</p>
        </div>
      </motion.div>
    </div>
  );
