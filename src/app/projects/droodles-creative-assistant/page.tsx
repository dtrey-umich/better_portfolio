    ...
    <div className="pt-20 pb-16 min-h-screen">
      ...
      >
        ...
        <div className="prose prose-lg max-w-none">
          <h3 className="text-xl font-semibold mt-6 mb-3"><span style={{color: "#EC6F6B", fontFamily: "Trey Handwrite, cursive"}}>TLDR</span></h3>
...
<h3 className="text-xl font-semibold mt-6 mb-3"><span style={{color: "#EC6F6B", fontFamily: "Trey Handwrite, cursive"}}>My role</span></h3>
...
<h3 className="text-xl font-semibold mt-6 mb-3"><span style={{color: "#EC6F6B", fontFamily: "Trey Handwrite, cursive"}}>The publication</span></h3>
...
<h3 className="text-xl font-semibold mt-6 mb-3"><span style={{color: "#EC6F6B", fontFamily: "Trey Handwrite, cursive"}}>A fun little comic I made that explains our system</span></h3>
