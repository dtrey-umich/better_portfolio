    ...
    <div className="pt-32 pb-16 min-h-screen">
      ...
      >
        ...
        <div className="prose prose-lg max-w-none">
          <p className="mb-6">During the pandemic, I started wearing this orange hat that my dad gave me every day. It made keeping my hair out of my eyes easy and I liked its worn look. At some point when I realized the hat was an important part of my wardrobe, I originally designed a simple yet weak little hook to place next to my door where I could store it initially. This worked for a while until I realized that I had more things I wanted to store in the same location that the hook couldn’t handle (like my jacket and growing hat collection). I needed a vertical coat rack with multiple hooks, so I made one.
