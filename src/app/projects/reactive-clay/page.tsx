...
const photos3 = [
  {
    "src": "/images/reactive_clay/sch.jpg",
    "width": 3509,
    "height": 2480,
    ...
    <div className="pt-20 pb-16 min-h-screen">
      ...
      >
        ...
        <div className="flex justify-between items-center mb-8">
          <p className="text-xl" style={{ fontFamily: 'Trey Handwrite, cursive', color: '#EC6F6B' }}>What if I made a robot out of ceramics?</p>
...
<div className="my-8"><ImageGrid photos={photos2} layout="rows" columns={2} spacing={16} /></div>
<p className="mb-6">The electrical system is comprised of 12 bus-connected nodes, each in control of a rotary encoder with a push button, solenoid, and 6 addressable RGB LEDs. Because of inherent space constraints created by the ceramic bodies and the need for 12 identical nodes, creating a PCB was the best choice. </p>
<p className="mb-6">The independent nodes communicate using an RS-485 bus arbitrated by an ESP32-based controller. At the start of the project, I considered simply adding a return data line to the SPI communication used by many addressable RGB LEDs. But, as I refined the viewer interaction to focus on turning the ceramics, the design required a communication paradigm that could expand to control many components. A cheap microcontroller on each node for local control and global communication over RS-485 was the next best choice. </p>
...
<div className="my-8"><ImageGrid photos={photos4} layout="columns" columns={2} spacing={16} /></div>
<p className="mb-6"></p>
