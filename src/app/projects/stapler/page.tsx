    ...
    <div className="pt-32 pb-16 min-h-screen">
      ...
      >
        ...
        <div className="prose prose-lg max-w-none">
          <p className="mb-6">At one point in the pandemic, I was sick of using the stapler in my house to staple stuff I was working on for online school. In need of a small project, I found this stapler at an estate sale. I fell in love with its style and wanted to clean it up, surpassing its former glory. I decided that giving it a red coat of paint would bring out its sleek form. In the end, it turned out to be a brilliantly colored piece of equipment in the end.
