    ...
    <div className="pt-32 pb-16 min-h-screen">
      ...
      >
        ...
        <div className="prose prose-lg max-w-none">
          <p>I live on a Trail in Dallas, Texas and when spring comes around, the flowers in the grass on either side of the trail bloom in all their orange and yellow beauty. They brighten up my neighborhood and give our trails a distinctive look. I shot these photos in the height of spring when all of the flowers on my local trail were in full bloom. I picked as many varieties as I could, brought them into my studio, and shot them against a black background with my macro lens.
...
<p>precursor to my Robot Arm project in which I seek to use robotics to film clips like these but at a much larger scale.</p>
        </div>
      </motion.div>
    </div>
  );
