    ...
    <div className="pt-32 pb-16 min-h-screen">
      ...
      >
        ...
        <div className="prose prose-lg max-w-none">
          <p className="mb-6">When I can, I watch The Great Pottery Throw Down with my parents. We like how the potters overcome unexpectedly difficult challenges and admire the craftsmanship of the contestants’ builds. This clock is inspired by that show. I tried to pick colors that give a nod to the soft colors of clay and incorporated a design that I might see on the show. If I had the tools to work with clay, I would have done this in clay. Instead, I stuck to what I’m strong with acrylic paint, polycarbonate sheets, and computer-aided design.
