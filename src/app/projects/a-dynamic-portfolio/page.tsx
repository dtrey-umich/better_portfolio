...
const photos3 = [
  ...
  },
  {
    ...
    "width": 820,
    "height": 170,
    "alt": "The current yellow bolt logo, looking more handmade than ever"
  },
  {
    "src": "/images/portfolio/icons.jpg",
    "width": 718,
    "height": 902,
    "alt": "The final project topic icon designs"
  }
];
const photos4 = [
  {
...
<p className="mb-6">My difficulties with Squarespace presented enough of a creative barrier that I never wanted to update my website. But, a lack of time to learn the basics of developing in React or Javascript prevented me from considering this possibility. When <a href="https://cloud.google.com/discover/what-is-vibe-coding" target="_blank" rel="noopener noreferrer"><span className="transition-opacity duration-200 hover:opacity-60" style={{color: "#5B9BD5"}}>“vibe coding”</span></a> started gaining traction online, I realized that LLM-based programming assistants were powerful enough that I didn’t have to know anything about React or Javascript to make a website that suits all my needs. And, along the way, I could discover how to better integrate LLMs into my workflow to open more possibilities in developing projects that were originally outside of my skillset.</p>
<div className="my-8"><ImageGrid photos={photos1} layout="columns" columns={1} spacing={16} /></div>
<p className="mb-6">I started the project by framing the visual design of the website. The most important design principle was to imagine each project as a single piece in a larger narrative. On the surface level of the site design, each project is organized into a “card” with just the most important information. The typical viewer can get a sense of several projects in an instant by looking at several of these cards, while still retaining access to in-depth information about the project by clicking on the card. Keeping each project compartmentalized in this way also enables them to be rearranged in appealing ways depending on the viewer. I used these ideas to mock-up some basic designs in Figma. Below, you can see my original design for a home page with several projects (left) and a more experimental project-based story page (right).</p>
<div className="my-8"><ImageGrid photos={photos2} layout="columns" columns={2} spacing={16} /></div>
<p className="mb-6">These two mock-ups show that rapidly reorganizing the project cards makes my portfolio accessible to a broader audience and displays the connection between projects. In the home page, by reorganizing the cards into a grid based on a set of project topics chosen by the viewer, my portfolio is automatically curated for the viewer and the most relevant projects rise to the top. This makes my portfolio more accessible for someone from any discipline. In the story pages, I am able to give the viewer a sense of how my projects fit together. And, displaying the interactions between my projects is a advantage of being interdisciplinary that no other portfolio design I have seen leverages. Ultimately, by addressing these challenges, the design works more cohesively with my writing to make my interdisciplinary set of works understandable to a broader audience. </p>
<div className="my-8"><ImageGrid photos={photos3} layout="columns" columns={3} spacing={16} /></div>
